...
<div class="wrap">
  ...
  <div class="body">
    ...
    <p style="font-size:15px">Cher(e) <strong><?php echo e($client->display_name); ?></strong>,</p>
    <p style="font-size:14px;color:#64748b;line-height:1.6">
      Votre paiement a bien été reçu et enregistré dans notre système. Merci pour votre règlement.
    </p>

    <div class="row"><span class="lbl">Référence encaissement</span><span class="val"><?php echo e($encaissement->reference); ?></span></div>
    <div class="row"><span class="lbl">Facture réglée</span><span class="val"><?php echo e($encaissement->invoice->number); ?></span></div>
    <div class="row"><span class="lbl">Montant réglé</span><span class="val"><?php echo e($amount); ?></span></div>
    <div class="row"><span class="lbl">Méthode de paiement</span><span class="val"><?php echo e(ucfirst(str_replace('_', ' ', $encaissement->payment_method))); ?></span></div>
    <div class="row"><span class="lbl">Date de paiement</span><span class="val"><?php echo e($date); ?></span></div>
    <div class="row"><span class="lbl">Enregistré par</span><span class="val"><?php echo e($encaissement->creator->name); ?></span></div>

    <?php if($status === 'INCOMPLET'): ?>
      <div style="margin-top:16px;padding:12px 16px;background:#fef2f2;border:1px solid #fecaca;border-radius:6px;font-size:13px">
        ...
        <span style="color:#7f1d1d">Montant facture : <?php echo e($invoice->total_formatted); ?> | Montant reçu : <?php echo e($amount); ?></span><br>
        <span style="color:#7f1d1d">Solde restant dû : <strong><?php echo e($remaining); ?></strong></span>
      </div>
    <?php endif; ?>

    <div style="text-align:center;margin-top:12px">
      <span class="status-badge <?php echo e($status === 'COMPLET' ? 'status-complete' : 'status-incomplete'); ?>">
        <?php echo e($status === 'COMPLET' ? '✓ PAIEMENT COMPLET' : '⚠ PAIEMENT INCOMPLET'); ?>

      </span>
    </div>

    <div class="ref">
      📋 Référence : <strong><?php echo e($encaissement->reference); ?></strong><br>
  ...
  <div class="foot">© <?php echo e(date('Y')); ?> BLOOSAT — Conservez ce reçu pour vos archives.</div>
</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\bss\backend\resources\views/emails/payment-receipt.blade.php ENDPATH**/ ?>